...
class SidebarFrame(customtkinter.CTkFrame):
    def __init__(self, master, controller, *args, **kwargs):
        ...
        # Widgets
        self.logo_label = customtkinter.CTkLabel(self, text="Menu", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))

        self.sidebar_button_1 = customtkinter.CTkButton(self, text="Botão 1")
        self.sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)

        self.sidebar_button_2 = customtkinter.CTkButton(self, text="Botão 2")
        self.sidebar_button_2.grid(row=2, column=0, padx=20, pady=10)

        self.sidebar_button_3 = customtkinter.CTkButton(self, text="Botão 3")
    ...
    def build_options(self):
        # Aparência
        self.appearance_mode_label = customtkinter.CTkLabel(self, text="Aparência:", anchor="w")
        ...
        # Tema
        self.theme_mode_label = customtkinter.CTkLabel(self, text="Tema:", anchor="w")
        ...
        # Escala
        self.scaling_label = customtkinter.CTkLabel(self, text="Escala:", anchor="w")
